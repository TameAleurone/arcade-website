...
(function(){
  ...
  const PEER_CONFIG={host:'0.peerjs.com',port:443,path:'/',secure:true,debug:1,config:{iceServers:[{urls:'stun:stun.l.google.com:19302'},{urls:'stun:stun1.l.google.com:19302'}]}};
  function loadPeerJS(){
  ...
  function wire(c,onMessage,onClose,onConnect){
    ...
    setTimeout(()=>{ if(!conn.open && onClose) onClose(new Error('Connection timed out')); },15000);
  }
